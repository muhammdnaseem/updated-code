...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        // Update user details but don't modify googleId or facebookId if they are null
        user.name = name;
...
// Function to cleanup users with googleId: null ye oshi Script ka clean karne ka method hay. 
